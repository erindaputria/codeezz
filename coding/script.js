    ...
    filtered.forEach((char, index) => {
        ...
        card.innerHTML = `
            <div class="character-image ${char.faction}">
                <img src="${char.image}" alt="${char.name}" class="character-photo"
                     onerror="this.style.display='none'; this.parentElement.querySelector('.character-emoji').style.display='block';">
                <span class="character-emoji" style="display:none;">${char.emoji}</span>
    ...
    houses.forEach(house => {
        ...
        card.innerHTML = `
            <div class="house-sigil-container">
                <img src="${house.image}" alt="House ${house.name}" class="house-sigil-img"
                     onerror="this.style.display='none'; this.parentElement.querySelector('.house-sigil').style.display='block';">
    ...
    dragons.forEach(dragon => {
        ...
        card.innerHTML = `
            <div class="dragon-image">
                <img src="${dragon.image}" alt="${dragon.name}" class="dragon-photo">
            </div>
...
function openModal(char) {
    ...
    body.innerHTML = `
        <div class="modal-character-header">
            <img src="${char.image}" alt="${char.name}" class="modal-character-photo"
